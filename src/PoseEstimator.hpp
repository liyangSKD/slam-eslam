...
public:
    ...
    void project(const BodyContactPoints& state, const base::Quaterniond& orientation);
    void update(const BodyContactPoints& state, const base::Quaterniond& orientation, const std::vector<terrain_estimator::TerrainClassification>& ltc );
...
private:
    void updateWeights(const BodyContactPoints& state, const base::Quaterniond& orientation);
    ...
    void sampleFromHash( double replace_percentage, const BodyContactPoints& state, const base::Quaterniond& orientation );
